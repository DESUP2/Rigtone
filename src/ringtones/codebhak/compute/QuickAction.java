package ringtones.codebhak.compute;

import java.util.ArrayList;
import java.util.List;

import ringtones.codebhak.R;
...
public class QuickAction extends PopupWindows implements OnDismissListener {
	...
	public QuickAction(Context context) {
		...
		mTrackAnim 	= AnimationUtils.loadAnimation(context, R.anim.transform);
		...
		setRootViewId(R.layout.fasttap);
	...
	public void setRootViewId(int id) {
		View root = (ViewGroup) inflater.inflate(id, null);
...
//		setContentView(mRootView);
	...
	public void addActionItem(ActionItem action) {
		...
		final View container	= (View) inflater.inflate(R.layout.tapicons, null);
